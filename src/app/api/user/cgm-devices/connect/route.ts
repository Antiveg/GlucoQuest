...
import { updateCGMDeviceConnectionStatusService } from "@/lib/services/cgm-device/cgm-device-services";
...
export async function PATCH(request : NextRequest){
    ...
    try {
        ...
        const response = await updateCGMDeviceConnectionStatusService(
